...
class badlapuradapter(
    val listener: MyClickListener,
    val context: Context,
    val location: List<placebadlapur>,
    val img: List<Int>,
    val ratings: List<String>,
) : RecyclerView.Adapter<badlapuradapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.badlapur_list, parent, false)
