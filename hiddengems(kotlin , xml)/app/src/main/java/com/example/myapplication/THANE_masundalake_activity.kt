...
class THANE_mansudalake_activity : ComponentActivity() {

    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_thane_masundalake)
        ...
        cafe1.setOnClickListener {
            startCafeActivity(17)
        }
        cafe2.setOnClickListener {
            startCafeActivity(18)
        }
    }

    private fun openLocationInMaps() {
        val latitude = "19.19344354850008" // Latitude of the location
        val longitude = "72.97605959407605" // Longitude of the location
    ...
    private fun shareLiveLocationInMaps() {
        ...
        val currentLatitude = "19.19344354850008"
        val currentLongitude = "72.97605959407605"
