...
class dadaradapter(
    ...
    val context: Context,
    val location: List<placedadar>,
    val img: List<Int>,
    val ratings: List<String>,
) : RecyclerView.Adapter<dadaradapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.dadar_list, parent, false)
