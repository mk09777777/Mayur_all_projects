...
class CSMT_khadaparsi_activity : ComponentActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_csmt_khadaparsi)
        ...
        cafe1.setOnClickListener {
            startCafeActivity(25)
        }
        cafe2.setOnClickListener {
            startCafeActivity(26)
        }
    ...
    private fun openLocationInMaps() {
        val latitude = "18.972608372420357" // Latitude of the location
        val longitude = "72.83261381554443" // Longitude of the location
    ...
    private fun shareLiveLocationInMaps() {
        ...
        val currentLatitude = "18.972608372420357"
        val currentLongitude = "72.83261381554443"
