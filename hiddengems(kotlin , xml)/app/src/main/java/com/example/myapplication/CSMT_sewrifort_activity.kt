...
class CSMT_sewrifort_activity : ComponentActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_csmt_sewrifort)
        ...
        cafe1.setOnClickListener {
            startCafeActivity(31)
        }
        cafe2.setOnClickListener {
            startCafeActivity(32)
        }
    ...
    private fun openLocationInMaps() {
        val latitude = "19.00092148882884"// Latitude of the location
        val longitude = "72.86036252837224" // Longitude of the location
    ...
    private fun shareLiveLocationInMaps() {
        ...
        val currentLatitude = "19.00092148882884"
        val currentLongitude = "72.86036252837224"
