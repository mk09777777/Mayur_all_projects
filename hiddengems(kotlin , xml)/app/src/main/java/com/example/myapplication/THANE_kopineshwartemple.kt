...
class THANE_kopineshwartemple_activity : ComponentActivity() {

    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_thane_kopineshwartemple)
        ...
        cafe1.setOnClickListener {
            startCafeActivity(19)
        }
        cafe2.setOnClickListener {
            startCafeActivity(20)
        }
    }

    private fun openLocationInMaps() {
        val latitude = "19.193097936874373" // Latitude of the location
        val longitude = "72.97731668236271" // Longitude of the location
    ...
    private fun shareLiveLocationInMaps() {
        ...
        val currentLatitude = "19.193097936874373"
        val currentLongitude = "72.97731668236271"
