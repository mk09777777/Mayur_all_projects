...
class CSMT_kotachiwadi_activity : ComponentActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_csmt_kotachiwadi)
        ...
        cafe1.setOnClickListener {
            startCafeActivity(29)
        }
        cafe2.setOnClickListener {
            startCafeActivity(30)
        }
    ...
    private fun openLocationInMaps() {
        val latitude = "18.956071732628164" // Latitude of the location
        val longitude = "72.82051084004883" // Longitude of the location
    ...
    private fun shareLiveLocationInMaps() {
        ...
        val currentLatitude = "18.956071732628164"
        val currentLongitude = "72.82051084004883"
